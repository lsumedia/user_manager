...
class ajax_list{
    ...
    public function display(){
        ...
        if($count > 10){
            ...
            echo "<div class=\"col s12 l9\"><input onkeyup=\"list_search('$this->id','$data_id',this.value);\" placeholder='Search' type='text' id='$search_id' class='form-control' /></div>";
            ...
            echo "<div class=\"listnav col s12 l3\"><p>Page <span id='$page_number'>1</span> of $numpages</p>$back$next</div>";
        }
        echo "</div>";
